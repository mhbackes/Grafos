...
; Exemplos:
; (acha-caminho 0 2 g1 3)
; deve retornar empty

; (acha-caminho 0 0 g1 3)
; deve retornar empty

; (acha-caminho 1 0 g2 3)
; deve retornar (list (list 1 0))

; (acha-caminho 1 1 g2 3)
; deve retornar (list (list 1 0 1) (list 1 0 1) (list 1 2 1))
...
; (distância 0 2 g1)
; deve retornar #i+inf.0 (infinito positivo)
...
; Observação: funções acha-caminho e distância devem ser chamadas manualmente